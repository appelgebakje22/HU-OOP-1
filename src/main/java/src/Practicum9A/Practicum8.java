...
public class Practicum8 {
	...
	private static abstract class Voertuig implements Goed {
		...
		@Override
		public String toString() {
			return String.format("Voertuig: %s met bouwjaar %s heeft een waarde van: %s", this.type, this.bouwjaar, Utils.euroBedrag(this.huidigeWaarde()));
		}
	}
	...
	private static class Computer implements Goed {
		...
		@Override
		public String toString() {
			return String.format("Computer: %s met productiejaar %s heeft een waarde van: %s", this.type, this.productieJaar, Utils.euroBedrag(this.huidigeWaarde()));
		}
	}
}
